          ...
          >
            <div className="max-w-lg">
              ...
              <div className="mt-6 flex flex-wrap justify-center gap-3">
                <a
                  href="#projects"
                  className="inline-flex items-center gap-2 rounded-xl bg-indigo-600 px-4 py-2 text-white hover:bg-indigo-700 transition-colors duration-300"
                >
                ...
                <a
                  ...
                  download
                  className="inline-flex items-center gap-2 rounded-xl border px-4 py-2 transition-transform duration-300 hover:scale-105 hover:shadow-lg"
                >
                  <FileDown size={16} />
                  Download CV
                </a>
              ...
              <div className="mt-6 flex flex-wrap justify-center gap-4 text-sm opacity-80">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center gap-2 hover:opacity-100 hover:text-indigo-600 transition-colors duration-300"
                >
                  <Github size={16} />
                  GitHub
                </a>
